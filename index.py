...
spiderman = movies.Movie("Spider-Man: Homecoming (2017)"
                         ...
                         ,['Tom Holland','Michael Keaton','Robert Downey Jr.','Marisa Tomei','Zendaya','Gwyneth Paltrow']
...
pink = movies.Movie("Pink (2016)"
                    ...
                    ,"Shoojit Sircar , Aniruddha Roy Chowdhury & Ritesh Shah(story), Ritesh Shah (dialogue & screenplay )"
...
neerja = movies.Movie("Neerja (2016)"
                      ...
                      ,"Ram Madhvani"
                      ,"Saiwyn Quadras (story and screenplay) (as Saiwyn Qadras), Sanyukta Shaikh Chawla (dialogue)"
                      ,['Sonam Kapoor', 'Shabana Azmi', 'Yogendra Tikku']
                      ,movies.Movie.RATINGS[3])

movie_list = [spiderman, lion, thewalk, pink, despicableme, avatar, neerja]
